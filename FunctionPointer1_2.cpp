/**
 * @file FunctionPointer1_2.cpp
 * @author Md. Yousuf Ali (yousuf.cse17@gmail.com)
 * @brief Application: function pointer for eliminate switch-case statement (Pointer Notation)
 * @version 0.1
 * @date 2022-09-22
 * @since ThursDay; 05:42 PM
...
int main(int argc, char const *argv[]){
    ...
    do{
        ...
        /*Calling a function using POINTER NOTATION*/
